...
export default function Home() {
  return (
    <div className="bg-[#FFF0E7] min-h-screen py-4">
      ...
      <main className="max-w-2xl px-20 mx-auto text-center">
        <div className="flex items-center justify-between">
          ...
          <button type="button" className="inline-flex items-center px-4 py-2 mt-4 font-medium tracking-widest text-white border border-transparent rounded-full shadow-sm bg-rose-500 hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-400">
            Connect Wallet
          </button>
        </div>

        <div class="mt-8">
          <textarea name="about" rows="3" placeholder="What's happening?" className="block w-full text-lg bg-transparent border-2 rounded-md shadow-sm placeholder-rose-300 text-rose-900 border-rose-300 focus:ring-rose-500 focus:border-rose-500"></textarea>
        ...
        <div className="mt-8 text-center text-rose-300">
          No screeches yet
        </div>
      </main>
    </div>
